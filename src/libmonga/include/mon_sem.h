...
/**
 * 	Performs semantic analysis on every AST in a given array.
 * 
 * 	@param asts The pointer to the AST array to analyse.
 *  @param astCount The number of ASTS in the specified array.
 * 	@param semErrOutStream The output stream to direct semantic error messages to.
 * 	
 * 	@return One of the following:
 * 		MON_SUCCESS :: Semantic analysis ended correctly and no semantic errors
